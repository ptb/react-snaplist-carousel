import { useCallback, useRef, useState, useEffect, createElement, forwardRef } from 'react';
...
var SnapListComponent = function (_a, ref) {
    ...
    return (createElement("div", { className: mergeStyles(styles.snaplist, styles["snaplist_" + direction], disabled ? null : styles["snaplist_active_" + direction], disableScroll ? styles.snaplist_scroll_disabled : styles["snaplist_scroll_" + direction], hideScrollbar ? styles.snaplist_hide_scrollbar : null, className), style: {
            width: width,
            height: height,
...
var SnapList = forwardRef(SnapListComponent);
var SnapItem = function (_a) {
    ...
    var _d, _e, _f, _g;
    return (createElement("div", { className: mergeStyles(styles.snapitem, styles["snapitem_align_" + snapAlign], forceStop ? styles.snapitem_forcestop : null, className), style: {
...
var useScroll = function (_a) {
    var ref = _a.ref;
    var getScrollFor = useCallback(function (element) {
    ...
    var goTo = useCallback(function (element) {
...
var useDragToScroll = function (_a) {
    ...
    var elementPositionsX = useRef([]);
    var elementPositionsY = useRef([]);
    ...
    var registerEventListeners = useCallback(function () {
        if (!ref.current)
            return;
    ...
    var removeEventListeners = useCallback(function () {
        if (!ref.current)
            return;
...
var useVisibleElements = function (_a, selector) {
    ...
    var _c = useState(selector([0], null)), result = _c[0], setResult = _c[1];
    ...
    var onChangeWithDebounce = useCallback(debounceHOF(onChange, debounce), [onChange]);
    useEffect(function () {
        var _a;
...
export { SnapItem, SnapList, useDragToScroll, useScroll, useVisibleElements, isTouchDevice };
